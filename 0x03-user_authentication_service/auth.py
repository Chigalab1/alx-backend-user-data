...
class Auth:
    ...
    def register_user(self, email: str, password: str) -> User:
        """Functio that Registers a new user with the given email and password.
    ...
    def get_user_from_session_id(self, session_id: str) -> Union[User, None]:
        """Function that Retrieve a User object from a session ID.
    ...
    def destroy_session(self, user_id: int) -> None:
        """function to destroy the session associated with a user
    ...
    def get_reset_password_token(self, email: str) -> str:
        """Function that Generates a password reset token for a user.
    ...
    def update_password(self, reset_token: str, password: str) -> None:
        """Func that Updates a user's password using a reset token.
