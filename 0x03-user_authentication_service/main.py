...
def log_out(session_id: str) -> None:
    """Function to Tests tests the process of logging out from a session.
...
def reset_password_token(email: str) -> str:
    """func to Tests the process of requesting a password reset.
...
def update_password(email: str, reset_token: str, new_password: str) -> None:
    """My Tests updating a user's password.
